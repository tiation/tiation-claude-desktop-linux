---
layout: default
title: Tiation Claude Desktop Linux - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Claude Desktop Linux</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-claude-desktop-linux" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-claude-desktop-linux .

# Run container
docker run -p 8080:8080 tiation-claude-desktop-linux
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-claude-desktop-linux)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-claude-desktop-linux/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-claude-desktop-linux/discussions)
